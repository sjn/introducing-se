...
\
Have you offered critique? Facts? De&shy;ri&shy;sion? A pas&shy;sio&shy;nate plea to change their mind, but failed? Or do you just avoid it all, distancing yourself?
...
* Are there any other underlying reasons supporing this?
* Try to find the most important source, experience or reason.
...
* ❌ Academic publi&shy;cations that don't pass [the C.R.A.A.P. test](https://en.m.wikipedia.org/wiki/CRAAP_test).
